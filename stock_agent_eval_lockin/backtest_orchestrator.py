...
class BacktestOrchestrator:
    ...
    def _update_daily_summary(self, trade: Dict):
        ...
        try:
            ...
            summary_file = "trading_summary_" + trade_date + ".json"
            ...
            # Update summary using the same portfolio value calculation
            summary["portfolio_value"] = self._calculate_portfolio_value()
