...
class StockDataFmpApi:
    ...
    def get_income_statement(self, symbol: str, period: str = 'quarter', limit: int = 4) -> List[Dict]:
        ...
        """
        endpoint = f"income-statement/{symbol}"  # Updated to include symbol in endpoint
        params = {
            'period': period,
            'limit': limit
        }
    ...
    def get_balance_sheet(self, symbol: str, period: str = 'quarter', limit: int = 4) -> List[Dict]:
        ...
        """
        endpoint = f"balance-sheet-statement/{symbol}"  # Updated to include symbol in endpoint
        params = {
            'period': period,
            'limit': limit
        }
    ...
    def get_cash_flow(self, symbol: str, period: str = 'quarter', limit: int = 4) -> List[Dict]:
        ...
        """
        endpoint = f"cash-flow-statement/{symbol}"  # Updated to include symbol in endpoint
        params = {
            'period': period,
            'limit': limit
        }
