...
It’s tailored to this specific 20-stock run and not packaged for easy OSS reuse. The current design surfaced considerable noise between the Reasoning Agent and Portfolio Manager; despite some insightful LLM outputs, the end-to-end behavior is suboptimal. I’ve now built a new MCP-based system, with tool-calling and database querying with easy integration and it's substantially more configureable (a lot less harcoded)  - https://github.com/1carlito/stock-wars .
